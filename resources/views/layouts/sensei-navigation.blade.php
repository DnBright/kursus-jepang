<nav class="p-8 space-y-10 flex flex-col h-full bg-slate-900 border-r border-white/5">
    ...
    <div class="space-y-2 flex-1 overflow-y-auto pr-2 custom-scrollbar">
        ...
        <x-sidebar-link :href="route('sensei.materials.index')" :active="request()->routeIs('sensei.materials.index')" class="!bg-transparent text-slate-400 hover:text-white transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
            Modules & Materials
        </x-sidebar-link>

        <x-sidebar-link :href="route('sensei.quizzes.index')" :active="request()->routeIs('sensei.quizzes.index')" class="!bg-transparent text-slate-400 hover:text-white transition-colors">
        ...
        <x-sidebar-link :href="route('sensei.schedule.index')" :active="request()->routeIs('sensei.schedule.index')" class="!bg-transparent text-slate-400 hover:text-white transition-colors">
