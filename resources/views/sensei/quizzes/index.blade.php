                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl hover:border-red-100 transition-all group">
                            ...
                            <div class="flex items-center justify-between mt-auto pt-4 border-t border-slate-50">
                                ...
                                <a href="{{ route('sensei.roadmap.manage', $program['id']) }}" class="px-3 py-1.5 bg-slate-900 text-white text-[10px] font-bold rounded-lg hover:bg-slate-800 transition-all flex items-center gap-1.5">
