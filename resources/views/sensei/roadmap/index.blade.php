        ...
        @foreach($courses as $course)
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-lg transition-all group">
                <div class="p-6">
                    ...
                    <a href="{{ route('sensei.roadmap.manage', $course->id) }}" class="block w-full py-3 bg-slate-900 text-white text-center text-xs font-black uppercase tracking-widest rounded-xl hover:bg-red-600 transition-all">
                        Kelola Roadmap
                    </a>
                </div>
            </div>
