...
<head>
    ...
    <title>Masuk - Kursus Jepang</title>
...
<body class="font-sans antialiased text-slate-800 bg-white">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-red-900 relative overflow-hidden flex-col justify-between p-12 text-white">
            ...
            <div class="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-slate-900 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
            <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-96 h-96 bg-slate-900 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
            ...
            <div class="relative z-10 max-w-lg">
                <h2 class="text-4xl font-bold font-jp mb-4 leading-tight">Selamat Datang Kembali di Komunitas</h2>
                <p class="text-red-200 text-lg">Lanjutkan progress belajar Anda dan raih target JLPT tahun ini.</p>
            </div>

            <div class="relative z-10 text-sm text-red-300">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
            <div class="w-full max-w-md space-y-8">
                <div class="text-center lg:text-left">
                    <h2 class="mt-6 text-3xl font-bold text-slate-900">Selamat Datang Kembali! 👋</h2>
                    <p class="mt-2 text-sm text-slate-600">Masukan email dan password Anda untuk masuk.</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="mt-8 space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="block mt-2 w-full px-4 py-3 rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 transition-colors bg-slate-50" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="nama@email.com" />
                    ...
                    <div class="flex items-center">
                        <input id="remember_me" type="checkbox" class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded" name="remember">
